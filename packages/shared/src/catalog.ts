...
export function getBuiltinCatalog(): HabitQuestCatalog {
  ...
  return {
    ...
    levelUnlocks: [
      ...
      createLevelUnlock("weekly-challenges", 1, "Weekly Challenges", "Activate weekly contract tracking and rewards."),
      ...
      createLevelUnlock("season-pass", 1, "Season Pass", "Earn monthly season XP and claim tier rewards."),
      createLevelUnlock("profile-frames", 5, "Profile Frames", "Buy and equip profile frame cosmetics."),
      createLevelUnlock("monthly-challenges", 1, "Monthly Challenges", "Open monthly climb challenges and rewards."),
