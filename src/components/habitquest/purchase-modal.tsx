  ...
  return (
    ...
    >
      <motion.div
        ...
        tabIndex={-1}
        className="glass-panel w-full max-w-lg rounded-t-[1.5rem] border border-white/10 p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] outline-none sm:rounded-[2rem] sm:p-6"
