...
const RESOURCES = {
  ...
  claims: "POST /api/v1/claims/{challenges|quests|season|streak-freeze}",
  leaderboard: "GET /api/v1/leaderboard",
  friends: "GET /api/v1/friends · POST /api/v1/friends/requests · POST /api/v1/friends/requests/:id/accept · DELETE /api/v1/friends/requests/:id · DELETE /api/v1/friends/:userId · POST /api/v1/friends/:userId/nudge",
  boot: "POST /api/v1/session/boot",
  settle: "POST /api/v1/session/settle",
